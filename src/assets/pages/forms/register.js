        ...
        <div className='basic-information'>
          <details open>
            ...
            <div className='form'>
              ...
              <div className='form-grid-2'>
                ...
                <label htmlFor='idCardType'>
                  ...
                  >
                    ...
                    <option value='School/University ID'>School/University ID</option>
                    <option value='Health Insurance Card (PhilHealth)'>Health Insurance Card (PhilHealth)</option>
              ...
              <label htmlFor='otherIdCardType' className='form-grid-1' style={{ width: 'calc(100% - 20px)' }}>
                Specify Other ID Card Type (if Other) [Tukuyin ang Iba Pang Uri ng ID Card (kung Iba)]
                <input
                  type='text'
          ...
          <details>
            ...
            <div className='form'>
              ...
              <div className='form-grid-2'>
                ...
                <label>
                  Photo Copy of birth Certicate of Child/Children, 22 years old and below
                  <input 
                    type='file'
                    name=''
                    id=''
        ...
        <div className='requirements'>
          ...
          <div className='description'>
            ...
            <ol>
              ...
              <li>Photocopy ITR or Photocopy of 1 month pay slip (if employed)</li>
              ...
              <li>Photo Copy of birth Certicate of Child/Children, 22 years old and below</li>
              <li>Photo Copy of PWD ID (for PWD Child/Children)</li>
              <li>Photo Copy of Spouse Death Certificate(if widow/widower)</li>
