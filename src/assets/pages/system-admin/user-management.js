...
import SystemAdminHeader from './header';
import logo from '../../img/dswd.png';

function SystemAdminUserManagement() {
  useEffect(() => {
    document.title = "User Management | System Admin";
    //window.scrollTo(0, 0);
  }, []);
  ...
  // Function to open the account modal and set selected user
  ...
  return (
    <>
                  ...
                  {filteredData.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td style={{ display: 'flex' }}>
                        <button className='edit' onClick={() => openAccountModal(item)}>
                          Edit
                        </button>&nbsp;
                        <Link to='' className='archive'>Archive</Link>&nbsp;
      ...
      {isAccountModalOpen && selectedUser && (
        <form method='post' action='/submit' className='create-account-modal'>
          <div className='modal-content'>
            ...
            <label htmlFor='username'>
              ...
              <input
                type='text'
                placeholder='Enter its username'
            ...
            <label htmlFor='username'>
              ...
              <input
                type='password'
                placeholder='Enter its password'
                value={selectedUser.password}
                id='password'
              />
            </label>
            <div className='flex-btn-modals'>
              <button type='submit' className='save'>Save</button>
              <button onClick={closeAccountModal} className='close'>Close</button>
            </div>
          </div>
        </form>
      )}
